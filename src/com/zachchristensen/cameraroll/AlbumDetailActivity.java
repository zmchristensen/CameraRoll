...
public class AlbumDetailActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState == null) {
			...
			arguments.putString(AlbumDetailFragment.GALLERY_NAME, getIntent()
					.getStringExtra(AlbumDetailFragment.GALLERY_NAME));
			AlbumDetailFragment fragment = new AlbumDetailFragment();
			fragment.setArguments(arguments);
			getSupportFragmentManager().beginTransaction()
					.add(R.id.album_detail_container, fragment).commit();
		}
	}
